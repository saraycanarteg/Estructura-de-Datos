...
int main() {
    Lista_Doble<int>* lista_entero = new Lista_Doble<int>();
    Lista_Doble<float>* lista_flotante = new Lista_Doble<float>();
    Lista_Doble<double>* lista_doble = new Lista_Doble<double>();
    Lista_Doble<string>* lista_string = new Lista_Doble<string>();
    Lista_Doble<char>* lista_letras = new Lista_Doble<char>();
